...
$project_info = getProjectById($project_id);
...
<table class="body">
	<tr>
		<td class="nav" valign="top">
			...
			<tr onclick="loadList();"><td width="25%"><img src="../images/lists.png"></td><td class="left">Проект</td><td width="25%"><img id="img_pr" src="../images/arrow_down.png"></td></tr>
			  <tr onclick="window.location.href='Proj_initiation.php?project=<? echo $project_id?>'; return false;" class="second" id="listproject1" style="display: none;"><td></td><td class="left">Инициация</td><td><img src="../images/arrow.png"></td></tr>
		...
		<form action = "" method = "post">
			<table class="base">
				<tr>
					...
					<td colspan="2"><input class = "input" type = "text" name = "Full_name" value="<?echo $project_info["Full_name"]; ?>"/></td>
				</tr>
				<tr>
					<td><b>Короткое наименование:</td>
					<td colspan="2"><input class = "input" type = "text" name = "Short_name" value="<?echo $project_info["Short_name"]; ?>"/></td>
				</tr>
				<tr>
					<td><b>Дата начала:</td>
					<td colspan="2">
						<input type="date" name="dataStart" value="<?echo $project_info["DataStart"]; ?>"/>
					</td>
				</tr>
				<tr>
					<td><b>Дата окончания:</td>
					<td colspan="2">
						<input type="date" name="dataEnd" value="<?echo $project_info["DataEnd"]; ?>"/>
					</td>
				</tr>
				<tr>
					<td valign="top"><b>Основания для инициации:</td>
					<td colspan="2"><textarea class="initiation" name = "InitiationReason" ><?echo $project_info["InitiationReason"]; ?></textarea></td>
				</tr>
				<tr>
					<td valign="top"><b>Цель:</td>
					<td colspan="2"><textarea class="prod_and_goal" name = "Goal" style="margin-bottom: 10px;"><?echo $project_info["Goal"]; ?></textarea></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="2"><textarea class="initiation" name = "Description"><?echo $project_info["Description"]; ?></textarea></td>
				</tr>
				<tr>
					<td><b>Организация:</td>
    ...
    <div id="txt_4">
			<table class="base1">
				...
				<tr>
					<td><button class="saveanddel" id="save" value="qwe" onclick="save_data(this.value, document.getElementById('name').value);">Сохранить</button></td>
					<td colspan="2"><button class="saveanddel" id="delete" value="qwe" onclick="delete_data(this.value);">Удалить</button></td>
				</tr>
				<tr>
					<td colspan="3">
	...
	<input class = "button" type = "submit" style="margin-top: 15px;" name = "create_project" value = "Изменить данные" />
	</form>
	</td>
</tr>
</table>
