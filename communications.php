	...
	<tr>
		<td class="nav" valign="top">
			...
			<tr onclick="loadList();"><td width="25%"><img src="../images/lists.png"></td><td class="left">Проект</td><td width="25%"><img id="img_pr" src="../images/arrow_down.png"></td></tr>
			  ...
			  <tr onclick="window.location.href='communications.php?project=<? echo $project_id; ?>'; return false;" id="listproject6" style="display: none;"><td></td><td class="left">Коммуникации</td><td><img src="../images/arrow.png"></td></tr>
		...
		<td valign="top">
	    <h1 style="margin-left: 50px;  margin-top: 25px;">Коммуникации</h1>
		...
		<table class="table_task" id='table_risk' width="90%" style="margin-bottom: 20px; margin-top: 10px; margin-left: 50px;">
		<tr>
			<th>Наименование</th>
			<th>Отправитель</th>
			<th>Получатель</th>
		...
		document.getElementById('delete_risk').setAttribute('onclick', 'deleteElem(\'row_1\'); return false;')">
			<td id="r1td1">Отчет о работе</td>
			<td id="r1td2"><a href="#">Петров Петр</a></td>
			<td id="r1td3"><a href="#">Иванов Иван</a></td>
			<td id="r1td4">Электронная почта</td>
			<td id="r1td5">1 раз в неделю</td>
		</tr>
		</table>
	</td>
</tr>
