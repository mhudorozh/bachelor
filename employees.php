	...
	<tr>
		<td class="nav" valign="top">
			...
			<tr onclick="loadList();"><td width="25%"><img src="../images/lists.png"></td><td class="left">Проект</td><td width="25%"><img id="img_pr" src="../images/arrow_down.png"></td></tr>
			  ...
			  <tr onclick="window.location.href='employees.php?project=<? echo $project_id?>'; return false;" id="listproject5" class="second" style="display: none;"><td></td><td class="left">Сотрудники</td><td><img src="../images/arrow.png"></td></tr>
		...
		<td valign="top">
	    <h1 style="margin-left: 50px;  margin-top: 25px;">Сотрудники</h1>
		...
		document.getElementById('delete_risk').setAttribute('onclick', 'deleteElem(\'row_1\'); return false;')">
			<td id="r1td1">Иванов Иван</td>
			<td id="r1td2">Бухгалтер</td>
			<td id="r1td3">5/2</td>
			<td id="r1td4">20000</td>
			<td id="r1td5">руб./месяц</td>
		</tr>
		</table>
	</td>
</tr>
